      ...
      <div className="w-full max-w-md mx-auto my-auto z-10 py-6">
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-7 md:p-8 shadow-xl shadow-black/5 dark:shadow-black/30 backdrop-blur-sm">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[var(--accent-soft)] text-[var(--accent)] border border-[var(--accent-border)] text-[11px] font-medium mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm bg-[var(--bg)] border border-[var(--border)] rounded-lg text-[var(--text-primary)] placeholder-[var(--text-dim)] focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] transition-colors"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-10 py-2 text-sm bg-[var(--bg)] border border-[var(--border)] rounded-lg text-[var(--text-primary)] placeholder-[var(--text-dim)] focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] transition-colors"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-2 py-2.5 px-4 rounded-lg bg-[var(--accent)] hover:opacity-90 active:scale-[0.99] text-white text-sm font-medium transition-all shadow-md shadow-[var(--accent)]/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 pt-4 border-t border-[var(--border)] flex items-center justify-center gap-2 text-[11px] text-[var(--text-dim)]">
